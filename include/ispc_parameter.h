...
const double weight_target_speed = 1e0;            // weight for max speed in lagrangian
const double weight_center_lane = 1e-1;            // weight for center lane
const double weight_heading = 1e2;                 // weight for heading
const double weight_input = 0.0;                   // weight for input
